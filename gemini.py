...
response = client.models.generate_content(
    ...
    contents=(
        ...
        "THE DATABASE_DUMP.SQL FILE THE QUERIES SHOULD BE VARIED DONT JUST HAVE INSERT COME ON AND HAVE SOMETHING INTERESTING TO ATTRACT AN ATTACKER"
...
try:
    ...
    for record in generated_data:
        ...
        elif "employee_id" in record and "salary" in record:  
            employee_payrolls.append(record)
        elif "table_name" in record and "query" in record:  
